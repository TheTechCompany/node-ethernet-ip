import { Socket, SocketConnectOpts, isIPv4 } from "net";
...
export default class ENIP extends EventEmitter {
    ...
    state : ({
        ...
        TCP: { establishing: boolean, established: boolean },
        ...
        scan_rate: undefined,
        timeout_sp: undefined,
        rpi: undefined,
        scanning: undefined,
        connectedMessaging: undefined,
    ...
    set establishing_conn(newEstablish) {
        ...
        if(!this.state.connection) throw new Error("No connection found");
    ...
    _handleDataEvent(data) {
        ...
        if (statusCode !== 0) {
            console.log(`Error <${statusCode}>:`, status.red);
